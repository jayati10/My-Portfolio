  ...
  return (
    ...
    <div name="contact"
         className="w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white">
            ...
            <br /><br />
                <br />
        <div className=" w-full flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            <div className="pb-2">
            ...
            <div className="flex justify-center items-center">
                <form action="https://getform.io/f/lbkmmjyb" method="POST"  className="flex flex-col w-full md:w-1/2 ">
